...
//gostatic
$(".gostatic_detail").hide();
$( ".gostatic_trigger" ).click(function() {
    if (!$(".gostatic_detail").is(":visible")) {
        $(".gostatic_detail").slideDown("slow");
    } else{
        $(".gostatic_detail").slideUp("slow");
    };
});
$( ".gostatic_detail" ).click(function() {
    $(".gostatic_detail").slideUp("slow");
});
